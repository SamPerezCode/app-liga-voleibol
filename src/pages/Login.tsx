const Login = () => {
  return (
    <div className="mx-auto grid max-w-6xl items-center gap-10 px-6 py-12 lg:grid-cols-2 lg:py-20">
      <div className="rounded-2xl border border-slate-200 bg-white p-8 shadow-card-soft">
